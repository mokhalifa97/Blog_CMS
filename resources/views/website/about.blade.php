...
@section('title', 'Airspace | About Us')
@section('content')
    ...
    <section class="about section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="about-img">
                        <img class="img-responsive" src="{{'assets/website/images/company/about.jpg'}}">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam qui vel cupiditate exercitationem, ea
                        ...
                        amet? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident, neque!</p>
                        ...
                        <div class="testimonial-slider owl-carousel">
                            <div>
                                ...
                                <p>"This Company created an e-commerce site with the tools to make our business a success,
                                    ...
                                    from the crowd."</p>
                                <div class="user">
                                    <img src="{{'assets/website/images/item-img1.jpg'}}" alt="Pepole">
                        ...
                        <div class="tab-content">
                            <div id="vision" class="tab-pane fade active in">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore nobis ducimus facere
                                    repellat harum, eius cupiditate, aliquam aut deserunt. Nemo illo ex impedit autem quod
                                    nobis architecto, velit quasi, aut voluptas porro natus. Fuga magnam perspiciatis fugit,
                                    placeat possimus officia non ducimus voluptatum aspernatur ad quidem neque accusantium
                                    repudiandae cupiditate nobis corporis, cum facere iusto, modi cumque consectetur saepe.
                                    Officia, molestiae tempore! Consequatur ipsa consequuntur saepe suscipit vero
                                    laudantium, mollitia, quaerat soluta nihil non tempore, quos dignissimos quasi ab
                                    officiis illum numquam quibusdam ducimus, veritatis ad. Quia, aliquid. Quaerat quos
                                    ducimus ipsam amet minus temporibus eos sequi alias hic nemo.</p>
                            </div>
