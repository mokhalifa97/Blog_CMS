...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="post-media post-thumb">
            <a href="blog-single.html">
                <img src="{{'assets/website/images/blog/blog-post-1.jpg'}}" alt="">
            </a>
        </div>
    ...
    <div class="post">
        <div class="post-media post-thumb">
            <a href="blog-single.html">
                <img src="{{'assets/website/images/blog/blog-post-2.jpg'}}" alt="">
            </a>
        </div>
    ...
    <div class="post">
        <div class="post-media post-thumb">
            <a href="blog-single.html">
                <img src="{{'assets/website/images/blog/blog-post-3.jpg'}}" alt="">
            </a>
        </div>
        ...
        <div class="widget widget-latest-post">
            ...
            <div class="media">
                <a class="pull-left" href="blog-single.html">
                    <img class="media-object" src="{{'assets/website/images/blog/post-thumb.jpg'}}" alt="Image">
                </a>
            ...
            <div class="media">
                <a class="pull-left" href="blog-single.html">
                    <img class="media-object" src="{{'assets/website/images/blog/post-thumb-2.jpg'}}" alt="Image">
                </a>
                <div class="media-body">
            ...
            <div class="media">
                <a class="pull-left" href="blog-single.html">
                    <img class="media-object" src="{{'assets/website/images/blog/post-thumb-3.jpg'}}" alt="Image">
                </a>
                <div class="media-body">
            ...
            <div class="media">
                <a class="pull-left" href="blog-single.html">
                    <img class="media-object" src="{{'assets/website/images/blog/post-thumb-4.jpg'}}" alt="Image">
                </a>
                <div class="media-body">
                    <h4 class="media-heading"><a href="blog-single.html">Introducing Swift for Mac</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, officia.</p>
